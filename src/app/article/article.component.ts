...
export class ArticleComponent implements OnInit {
  ...
  constructor(private route : ActivatedRoute, private articleService : ArticleService,private productService : ProductService,
    ...
    private router :Router , private cmsService : CMSService) {
      ...
      this.storageService.getFooterDirection().subscribe((direction) => {
        if (direction) {
          $('.footerbox').remove();
        }
      });
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe((params) => {
		console.log("params.get('sku')" + params.get('sku'));
    console.log("params.get('categoryId')" + params.get('categoryId'));
    this.categoryId=params.get('categoryId');
  ...
  footerDirection() {
    this.storageService.setFooterDirection(true);
     setTimeout(() => {
