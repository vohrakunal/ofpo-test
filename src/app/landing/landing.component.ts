...
export class LandingComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private storageService: StorageService, public http: Http, private messageService: MessageService, private router: Router,
      private menuService: MenuService, private cartService: CartService,private productService: ProductService, public _auth: AuthService,
      private spinnerService: SpinnerService,private wishlistService: WishlistService,private myAccountService: MyAccountService,private route: ActivatedRoute,
    ...
    this.route.paramMap.subscribe((params) => {
      if (params.get('reload') != null) {
        this.router.navigate(['']); // Change the location URL and reload. Else it will go in a loop.
